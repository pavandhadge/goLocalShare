  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex flex-col">
      ...
      <main className="flex flex-1 container mx-auto px-4 py-8 gap-8">
        <nav className="w-64 min-w-[180px] max-w-[220px]">
        ...
        <section className="flex-1 min-w-0">
          <Card className="p-10 bg-[#fcfcfd] shadow-xl border border-gray-200 max-w-none prose prose-lg prose-headings:text-gray-900 prose-headings:font-bold prose-headings:tracking-tight prose-headings:mt-10 prose-headings:mb-5 prose-h1:text-4xl prose-h2:text-3xl prose-h3:text-2xl prose-h4:text-xl prose-h5:text-lg prose-h6:text-base prose-blockquote:bg-gray-50 prose-blockquote:border-l-4 prose-blockquote:border-gray-300 prose-blockquote:pl-5 prose-blockquote:italic prose-blockquote:text-gray-700 prose-code:bg-gray-100 prose-code:text-gray-900 prose-code:rounded prose-code:px-1.5 prose-code:py-1 prose-pre:bg-gray-100 prose-pre:text-gray-900 prose-pre:rounded-lg prose-pre:p-5 prose-pre:overflow-x-auto prose-table:rounded-lg prose-table:overflow-hidden prose-table:border prose-table:border-gray-200 prose-th:bg-gray-50 prose-th:text-gray-900 prose-td:bg-white prose-td:border-gray-100 prose-td:p-4 prose-th:p-4 prose-table:my-6 prose-table:w-full prose-tr:hover:bg-gray-50 prose-p:leading-relaxed prose-p:my-5 prose-li:my-2 prose-ul:pl-7 prose-ol:pl-7 prose-hr:my-10 prose-a:text-blue-700 prose-a:underline prose-a:font-medium prose-a:hover:text-blue-900 text-gray-900 font-[Segoe_UI,Liberation_Sans,Arial,sans-serif]">
            <ReactMarkdown
              ...
              components={{
                ...
                th: ({ node, ...props }) => (
                  <th
                    {...props}
                    className="bg-gray-100 text-gray-700 p-3 border border-gray-200"
                  />
                ),
                td: ({ node, ...props }) => (
                  <td
                    {...props}
                    className="bg-white p-3 border border-gray-100"
                  />
                ),
                blockquote: ({ node, ...props }) => (
                  <blockquote
                    {...props}
                    className="bg-gray-50 border-l-4 border-gray-300 pl-4 italic text-gray-600 my-4"
                  />
                ),
